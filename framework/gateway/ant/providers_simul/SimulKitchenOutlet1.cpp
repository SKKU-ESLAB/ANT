...
class SensorReader
{
	...
	public:
		SensorReader(){
			...
			fd = open("sensor/kitchen/outlet1", O_RDWR | O_NONBLOCK );
...
public:
    ...
    OduinoResource()
    {
        ...
        m_name = "ESLab Outlet Sensor";
        m_power = 0;
        m_oduinoUri = "/kitchen/outlet1";
...
public:
    ...
    void put(OCRepresentation& rep)
    {
	    ...
	    if (rep.getValue("power", tempString))
            {
