...
class SensorReader
{
	...
	public:
		SensorReader(){
			...
			fd = open("sensor/kitchen/valve", O_RDWR | O_NONBLOCK );
...
public:
    ...
    OduinoResource()
    {
        ...
        m_name = "ESLab Valve Sensor";
        m_power = 0;
        m_oduinoUri = "/kitchen/valve";
...
public:
    ...
    void put(OCRepresentation& rep)
    {
	    ...
	    if (rep.getValue("state", tempString))
            {
