...
#define ANT_DBG_VERB(fmt, args...) do{ _ant_log(fmt, "[VERB] ML", 9, ##args); }while(0)
#define ANT_DBG_LOG(fmt, args...) do{ _ant_log(fmt, "[LOG] ML", 94, ##args); }while(0)
#define ANT_DBG_WARN(fmt, args...) do{ _ant_log(fmt, "[WARN] ML", 91, ##args); }while(0) 
#define ANT_DBG_ERR(fmt, args...) do{ _ant_log(fmt, "[ERR] ML", 101, ##args); }while(0)


#define __ANT_FUNCTION_ENTER__ do{ _ant_func("ENTER", "ML"); }while(0)
#define __ANT_FUNCTION_EXIT__ do{ _ant_func("EXIT", "ML"); }while(0)
