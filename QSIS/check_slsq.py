...
def main():
    ...
    optimizer_args = trainer.optimizer_arguments(weight_decay = 4e-5, learning_rate = 1e-3)
    ...
    trainer.validate(val_loader, teacher_model.eval(),criterion, -1,  monitors, args)
