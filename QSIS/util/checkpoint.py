...
def save_checkpoint_quantized(epoch, arch, qat_model, quantized_model = None, extras=None, is_best = None, name = None, output_dir='.'):
    scripted_quantized_model_file = arch + '_scripted_quantized_best.pth'
