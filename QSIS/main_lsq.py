...
def main():
    ...
    optimizer_args = trainer.optimizer_arguments(weight_decay = 4e-5, learning_rate = 5e-4)
    args = trainer.training_arguments(name = "88",device_gpu = [0], optimizer = optimizer_args, dataloader = data_args, arch = 'once_for_all', mode = "lsq", epochs = 140)
    ...
    wandb.init(reinit=True, name = experimental_name, project="LSQ_Quant_Pytorch")
