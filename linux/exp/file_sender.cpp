...
int main() {
  ethAdapter = new sc::EthServerAdapter(1, "Eth", 2345);
  btAdapter = new sc::BtServerAdapter(11, "Bt", "150e8400-1234-41d4-a716-446655440000");
  wfdAdapter = new sc::WfdServerAdapter(12, "Wfd", 3456, "SelCon");
