...
ASYNC_REGISTER_FUNC(ocf_adapter_onInitialize, NULL)
...
ASYNC_REGISTER_FUNC(ocf_adapter_onPrepareServer, NULL)
...
ASYNC_REGISTER_FUNC(ocf_adapter_onPrepareClient, NULL)
