package com.ant.ant_manager.view.cameraviewer;
...
public class GStreamerSurfaceView extends SurfaceView {
    ...
    // We will try to maximize our size, and preserve the media's aspect
    // ratio if
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.i("GStreamer",
                "onMeasure called with " + media_width + "x" + media_height);
        // Obey width rules
        switch (wmode) {
        ...
        switch (hmode) {
            case MeasureSpec.AT_MOST:
                if (wmode == MeasureSpec.EXACTLY) {
                    height =
                            Math.min(wsize * media_height / media_width, hsize);
                    break;
                }
            case MeasureSpec.EXACTLY:
                height = hsize;
