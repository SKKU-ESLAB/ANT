...
public class OldBTClientAdapter extends NetworkAdapter {
    private UUID uuid;
    private String dev_addr;
    private BluetoothSocket btSocket;
    private String kTag = "OldBTClientAdapter";
    private BufferedOutputStream writer;
    private BufferedInputStream reader;

    public OldBTClientAdapter(short id, String dev_addr, String svc_uuid) {
        this.dev_id = id;
