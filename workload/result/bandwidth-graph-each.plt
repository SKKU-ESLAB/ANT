...
set term png
set output "bandwidth-graph-1.png"
plot "capdynamic-mixed-1.log" using 1:($5/1000000) with lines ls 1 title "Cap-dynamic"
set output "bandwidth-graph-2.png"
plot "energyaware-mixed-2.log" using 1:($5/1000000) with lines ls 2 title "Energy-aware"
set output "bandwidth-graph-3.png"
plot "latencyaware-mixed-1.log" using 1:($5/1000000) with lines ls 3 title "Latency-aware"
set output "bandwidth-graph-4.png"
plot "appaware-mixed-3.log" using 1:($5/1000000) with lines ls 4 title "App-aware"
