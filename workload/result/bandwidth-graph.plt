set term png
set output "bandwidth-graph.png"
set autoscale
...
plot "capdynamic-mixed-1.log" using 1:($5/1000000) with lines ls 1 title "Cap-dynamic", \
     "energyaware-mixed-2.log" using 1:($5/1000000) with lines ls 2 title "Energy-aware", \
     "latencyaware-mixed-1.log" using 1:($5/1000000) with lines ls 3 title "Latency-aware", \
     "appaware-mixed-3.log" using 1:($5/1000000) with lines ls 4 title "App-aware"
