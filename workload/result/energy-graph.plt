...
plot "capdynamic-mixed-1.csv" using 1:($2/1000) every 8000 with lines ls 1 title "Cap-dynamic", \
     "energyaware-mixed-2.csv" using 1:($2/1000) every 8000 with lines ls 2 title "Energy-aware", \
     "latencyaware-mixed-1.csv" using 1:($2/1000) every 8000 with lines ls 3 title "Latency-aware", \
     "appaware-mixed-3.csv" using 1:($2/1000) every 8000 with lines ls 4 title "App-aware"
